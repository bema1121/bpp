package myExamples.replIt.tjmax;
...
public class TJMaxx {
    ...
    public List<String> getAllItemNames() {
       ...
       // return name;
        ...
        for (int i = 0; i < catalogNumber; i++) {
            if (regularItems.equals(catalogNumber)) {
        ...
        for (int i = 0; i < catalogNumber; i++) {
            if (onSaleItems.equals(catalogNumber)) {
                return catalogNumber;
    ...
    public OnSaleItem getOnSaleItem(String name) {
        //OnSaleItem obj = new OnSaleItem();
        for(int i = 0; i < name.length(); i++){
            if(onSaleItems.equals(name)){
                //return OnSaleItem;
    ...
    public void removeItem(int catalogNumber) {
        for(int i = 0; i < catalogNumber; i++){
            if(regularItems.get(i).equals(catalogNumber) || onSaleItems.get(i).equals(catalogNumber) ){
